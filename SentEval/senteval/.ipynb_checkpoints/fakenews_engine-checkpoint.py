...
from senteval.pairsFakeTrain import PairsFakeCLSTrain
...
class SE(object):
    ...
    def eval(self, name):
        ...
        if name == 'PosPairsCLS':
            self.evaluation = PairsFakeCLSTrain("nlp-brin-id/pos_pairs_filtered", "title-fact", "True", seed=self.params.seed)
